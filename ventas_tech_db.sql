...
-- Tabla productos: dimensión, depende de categorias (FK)
...
-- Tabla ventas: hechos, depende de clientes y productos (FK)
CREATE TABLE ventas (
...
-- productos — 6 registros (adaptado a TRUE para PostgreSQL)
